...
npm install –save-dev webpack-bundle-analyzer npx webpack-bundle-analyzer dist/bundle.js
...
Refactor your imports to only include what’s needed (e.g., for lodash, date-fns, or moment).
...
Bonus: Add code splitting for a rarely-used admin page and compare the initial chunk size before and after.
...
you can leave the last 8 problem and also think you as a senoir software dev and make this project extaclt descibe in this and also in this point 6 must matches all the stuff also not create any uncessasry md how project work